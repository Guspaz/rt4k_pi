...
- For rt4k_pi distribution and CI, publish Release-mode, self-contained, single-executable Native AOT builds for Linux ARM64, supporting Raspberry Pi OS Bookworm (Debian 12) and newer. Keep the build environment's glibc baseline compatible with Bookworm.
